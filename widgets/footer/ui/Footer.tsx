...
export function Footer({ lang, dict }: FooterProps) {
  return (
    <footer
      className='flex flex-col items-start justify-start gap-4 bg-gradient-to-t from-[#FCE4FF] to-[#FCE4FF] px-5 pt-5 pb-16'
      ...
      <div className='h-4 w-[61px]'>
        ...
        >
          <path
            ...
            fill='#F4A8FF'
          />
          <path d='M11.8034 9.18182V6.63636H17.8467V9.18182H11.8034Z' fill='#F4A8FF' />
          <path
            fillRule='evenodd'
            clipRule='evenodd'
