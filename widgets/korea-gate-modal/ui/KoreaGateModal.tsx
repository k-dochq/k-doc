  ...
  return (
    <DialogPrimitive.Root open={shouldShow} onOpenChange={() => undefined}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Overlay className='fixed inset-0 z-600 bg-white' />

        <DialogPrimitive.Content
          className='fixed top-[50%] left-[50%] z-600 w-[calc(100vw-60px)] max-w-[calc(500px-60px)] translate-x-[-50%] translate-y-[-50%] border-none bg-transparent p-0 shadow-none'
