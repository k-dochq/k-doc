...
import { LikeButtonWrapperV2 } from 'features/hospital-like';
import { useShare } from 'shared/lib/hooks/useShare';
import { ShareIconV2 } from 'shared/ui/icons';

interface HospitalDetailHeaderActionsV2Props {
  hospitalId: string;
  lang: Locale;
  dict: Dictionary;
  hospitalName?: string;
...
export function HospitalDetailHeaderActionsV2({
  hospitalId,
  lang,
  dict,
  hospitalName,
}: HospitalDetailHeaderActionsV2Props) {
  ...
  const shareUrl = `${baseUrl}/${lang}/v2/hospital/${hospitalId}`;
  ...
  return (
    <div className='flex items-center gap-3'>
      ...
      <LikeButtonWrapperV2 hospitalId={hospitalId} lang={lang} dict={dict} />
    </div>
  );
}
