            ...
            return (
              ...
              >
                <div className='flex w-full flex-col items-start overflow-clip rounded-xl bg-white/10 shadow-[0px_2px_4px_0px_rgba(0,0,0,0.2)]'>
                  {/* 이미지 스켈레톤 */}
                  <div className='h-[190px] w-full animate-pulse bg-white/90' />

                  {/* 텍스트 영역 스켈레톤 */}
                  <div className='flex w-full shrink-0 flex-col gap-0.5 px-5 py-4'>
                    {/* 지역/병원명 스켈레톤 */}
                    <div className='flex w-full shrink-0 items-center gap-1'>
                      <div className='h-4 w-20 animate-pulse rounded bg-white/90' />
                      <div className='size-[2px] rounded-full bg-white/90' />
                      <div className='h-4 w-24 animate-pulse rounded bg-white/90' />
                    </div>

                    {/* 내용 스켈레톤 */}
                    <div className='h-6 w-full animate-pulse rounded bg-white/90' />
                  </div>
                </div>
              </CarouselItem>
            );
