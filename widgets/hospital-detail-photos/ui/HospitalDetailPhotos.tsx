  ...
  return (
    <div className='relative max-h-[242px] w-full'>
      ...
      <LocaleLink
        ...
        locale={lang}
        className='fixed top-[78px] right-[max(20px,calc(50vw-250px+20px))] z-[60] flex min-h-[66px] min-w-[66px] items-center justify-center rounded-full bg-gradient-to-r from-primary-800 to-primary-900 shadow-[1px_3px_8px_0_rgba(0,0,0,0.15)]'
      >
