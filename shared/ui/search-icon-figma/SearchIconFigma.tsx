/**
 * Figma MCP에서 가져온 검색 아이콘 SVG 컴포넌트
 * 원본 SVG URL: https://www.figma.com/api/mcp/asset/6a971891-0488-4380-847d-56136a127b52
 */
interface SearchIconFigmaProps {
  className?: string;
  size?: number;
  color?: string;
}

export function SearchIconFigma({
  className = '',
  size = 20,
  color = '#A3A3A3',
}: SearchIconFigmaProps) {
  return (
    <svg
      className={className}
      width={size}
