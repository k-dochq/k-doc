...
import { CategoryFilterButtonV2 } from './ui/CategoryFilterButtonV2';

interface CategoryFilterTabsV2Props {
  lang: Locale;
  dict: Dictionary;
...
export function CategoryFilterTabsV2({
  lang,
  medicalSpecialties,
  selectedCategory,
  onCategoryChange,
}: CategoryFilterTabsV2Props) {
