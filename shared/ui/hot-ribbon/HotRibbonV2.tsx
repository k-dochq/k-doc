    ...
    <div className='absolute top-[-5px] left-[-5px] z-10 overflow-clip'>
      ...
      >
        <path
          ...
          fill='url(#paint0_linear_276_145)'
        />
        <path
          style={{ mixBlendMode: 'multiply' }}
          d='M4.98559 8C2.24273 8 0.0141602 13.8 0.0141602 20.9643C0.0141602 28.1286 2.24273 33.9286 4.98559 33.9286V8Z'
          fill='url(#paint1_radial_276_145)'
        />
        <path
          ...
          fill='url(#paint2_linear_276_145)'
        />
        <path
