  ...
  return (
    <div className='px-5 pt-8 pb-20'>
      ...
      <div className='flex flex-col gap-10'>
        ...
        <div className='flex flex-col gap-4'>
          <h2 className='text-2xl font-semibold text-neutral-700'>
            {dict.termsOfService.article16.title}
          </h2>
          <div className='flex flex-col gap-2'>
            {dict.termsOfService.article16.items.map((item, index) => {
              if (typeof item === 'string') {
                return (
                  <p key={index} className='text-base leading-6 font-normal text-neutral-700'>
                    {index + 1}. {item}
        ...
        <div className='flex flex-col gap-4'>
          <h2 className='text-2xl font-semibold text-neutral-700'>
            {dict.termsOfService.article17.title}
          </h2>
          <div className='flex flex-col gap-2'>
            {dict.termsOfService.article17.items.map((item, index) => {
              if (typeof item === 'string') {
                return (
                  <p key={index} className='text-base leading-6 font-normal text-neutral-700'>
                    {index + 1}. {item}
        ...
        <div className='flex flex-col gap-4'>
          <h2 className='text-2xl font-semibold text-neutral-700'>
            {dict.termsOfService.article19.title}
          </h2>
          <div className='flex flex-col gap-2'>
            {dict.termsOfService.article19.items.map((item, index) => (
              <p key={index} className='text-base leading-6 font-normal text-neutral-700'>
                {index + 1}. {item}
              </p>
            ))}
        ...
        <div className='flex flex-col gap-4'>
          <h2 className='text-2xl font-semibold text-neutral-700'>
            {dict.termsOfService.article20.title}
          </h2>
          <div className='flex flex-col gap-2'>
            {dict.termsOfService.article20.items.map((item, index) => (
              <p key={index} className='text-base leading-6 font-normal text-neutral-700'>
                {index + 1}. {item}
              </p>
            ))}
