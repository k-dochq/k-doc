    ...
    <div className='min-h-screen bg-white'>
          ...
          {Array.from({ length: 3 }).map((_, index) => (
            <div
              ...
              className={`h-2 w-2 animate-pulse rounded-full ${
                index === 0 ? 'bg-gray-100' : 'bg-gray-200'
              }`}
            ></div>
          ))}
        </div>
      ...
      <div className='px-4 py-2'>
        <div className='flex space-x-8'>
          ...
          <div className='relative'>
            ...
            {/* 선택된 탭 언더라인 */}
            <div className='absolute -bottom-2 left-0 h-0.5 w-full animate-pulse bg-gray-100'></div>
          </div>
        </div>
      </div>
      ...
      <div className='px-4 py-6'>
        <div className='space-y-6'>
          {/* 섹션 제목 */}
          <div className='h-7 w-32 animate-pulse rounded bg-gray-100'></div>

          {/* 인용문 박스 */}
          <div className='rounded-lg border-l-4 border-gray-200 p-4'>
          ...
          {/* 비디오 플레이어 */}
          <div className='relative h-48 w-full animate-pulse rounded-lg bg-gray-100'>
          ...
          {/* 비디오 설명 */}
          <div className='h-5 w-64 animate-pulse rounded bg-gray-100'></div>
            ...
            {Array.from({ length: 3 }).map((_, index) => (
              <div key={index} className='flex items-start space-x-3'>
                ...
                <div className='flex-1 space-y-2'>
                  ...
                  <div className='h-4 w-4/5 animate-pulse rounded bg-gray-100'></div>
