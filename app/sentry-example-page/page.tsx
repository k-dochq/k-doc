...
export default function Page() {
  ...
  useEffect(() => {
    // Sentry 연결 상태 확인을 위한 간단한 테스트
    async function checkConnectivity() {
      try {
        // Sentry SDK가 정상적으로 로드되었는지 확인
        setIsConnected(typeof Sentry.captureException === 'function');
      } catch (_error) {
    ...
    <div>
      ...
      <main>
        ...
        <p className='description'>
          ...
          <a target='_blank' href='https://k-doc.sentry.io/issues/?project=4510192293249104'>
            Issues Page
          </a>
