...
export function HospitalCardV2NameAndLocation({
  ...
  return (
    <div className='flex w-full shrink-0 flex-col items-start gap-0.5'>
      <p className='relative line-clamp-1 w-full shrink-0 text-sm leading-5 font-semibold text-neutral-700'>
        {hospitalName}
      </p>
      {location && (
        <div className='flex w-full min-w-0 shrink-0 items-center gap-1 overflow-hidden'>
          ...
          <div className='relative flex min-w-0 flex-1 items-center overflow-hidden py-0 pr-0'>
