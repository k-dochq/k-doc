...
export function ReviewStatsSectionV2({
  ...
  // 클라이언트에서 현재 사용자의 추천 상태 계산
  const isRecommendedByUser =
    user && review.recommendedUserIds ? review.recommendedUserIds.includes(user.id) : false;
