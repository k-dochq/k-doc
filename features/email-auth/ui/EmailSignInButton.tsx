...
export function EmailSignInButton({
  ...
  return (
    <LocaleLink
      ...
      className={`block w-full rounded-xl bg-primary-900 px-6 py-4 text-center transition-all hover:bg-primary-900/90 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-none ${className}`}
    >
