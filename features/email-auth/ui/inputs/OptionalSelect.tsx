  ...
  return (
    <div className='flex w-full flex-col gap-2'>
      ...
      <select
        ...
        disabled={disabled}
        className='w-full rounded-xl border border-neutral-300 bg-white px-4 py-4 pr-8 text-sm text-neutral-900 focus:border-transparent focus:ring-2 focus:ring-primary-900 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50'
        style={{
          appearance: 'none',
