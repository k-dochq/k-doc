      ...
      <div className='flex gap-2'>
        ...
        <div className='w-32'>
          <select
            ...
            disabled={disabled}
            className='w-full rounded-xl border border-neutral-300 bg-white px-3 py-4 pr-8 text-sm text-neutral-900 focus:border-transparent focus:ring-2 focus:ring-primary-900 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50'
            style={{
              appearance: 'none',
        ...
        <div className='flex-1'>
          <input
            ...
            disabled={disabled}
            className='w-full rounded-xl border border-neutral-300 bg-white px-4 py-4 text-sm text-neutral-900 focus:border-transparent focus:ring-2 focus:ring-primary-900 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50'
          />
        </div>
      </div>
