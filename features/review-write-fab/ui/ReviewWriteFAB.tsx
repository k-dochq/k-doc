    ...
    >
      <div className={`mx-auto ${MAX_MOBILE_WIDTH_CLASS} px-6`}>
        <button
          onClick={handleClick}
          disabled={isLoading}
          className='pointer-events-auto mx-auto flex h-14 items-center justify-center gap-2 rounded-full bg-[#DA47EF] px-6 text-white shadow-lg transition-all duration-200 hover:bg-[#C73AE0] hover:shadow-xl active:scale-95 disabled:cursor-not-allowed disabled:opacity-50'
