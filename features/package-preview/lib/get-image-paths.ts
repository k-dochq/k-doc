...
const IMAGE_PATHS: Record<PackageImageType, Record<Locale, string>> = {
  main: {
    ...
    ja: '/images/event/package/main_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  price: {
    ...
    ja: '/images/event/package/price_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  notice: {
    ...
    ja: '/images/event/package/notice_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  what: {
    ...
    ja: '/images/event/package/what_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  why: {
    ...
    ja: '/images/event/package/why_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  experience: {
    ...
    ja: '/images/event/package/experience_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  review: {
    ...
    ja: '/images/event/package/review_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  how: {
    ...
    ja: '/images/event/package/how_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  support: {
    ...
    ja: '/images/event/package/support_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  faq: {
    ...
    ja: '/images/event/package/faq_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  table: {
    ...
    ja: '/images/event/package/table_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  notice2: {
    ...
    ja: '/images/event/package/notice2_en.png', // 일본어 이미지가 없으면 영어 이미지 사용
  },
  bubble: {
