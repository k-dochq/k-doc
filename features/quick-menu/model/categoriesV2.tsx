...
const COMMON_CATEGORIES: CategoryItem[] = [
  // 첫째줄: 눈 > 코 > 리프팅 > 안면윤곽 > 가슴 > 줄기세포 (6개)
  {
    ...
    icon: () => <EyesIconV2 />,
    iconSmall: () => null,
    labels: { ko_KR: '눈', en_US: 'Eyes', th_TH: 'ดวงตา', zh_TW: '眼睛' },
  },
  {
    ...
    icon: () => <NoseIconV2 />,
    iconSmall: () => null,
    labels: { ko_KR: '코', en_US: 'Nose', th_TH: 'จมูก', zh_TW: '鼻子' },
  },
  {
    ...
    icon: () => <LiftingIconV2 />,
    iconSmall: () => null,
    labels: { ko_KR: '리프팅', en_US: 'Lifting', th_TH: 'ยกกระชับ', zh_TW: '拉提' },
  },
  {
  ...
  },
  {
    ...
    icon: () => <BreastIconV2 />,
    iconSmall: () => null,
    labels: { ko_KR: '가슴', en_US: 'Breast', th_TH: 'หน้าอก', zh_TW: '胸部' },
  },
  {
    ...
    icon: () => <StemCellIconV2 />,
    iconSmall: () => null,
    labels: { ko_KR: '줄기세포', en_US: 'Stem Cell', th_TH: 'เซลล์ต้นกำเนิด', zh_TW: '幹細胞' },
  },
  // 둘째줄: 지방흡입 > 바디 > 모발이식 > 피부과 > 치과 > 기타 (6개)
  {
    ...
    iconSmall: () => null,
    labels: { ko_KR: '지방흡입', en_US: 'Liposuction', th_TH: 'ศัลยกรรมดูดไขมัน', zh_TW: '抽脂' },
  },
  {
    ...
    icon: () => <BodyIconV2 />,
    iconSmall: () => null,
    labels: { ko_KR: '바디', en_US: 'Body', th_TH: 'ศัลยกรรมร่างกาย', zh_TW: '身體' },
  },
  {
    ...
    iconSmall: () => null,
    labels: { ko_KR: '모발이식', en_US: 'Hair Transplant', th_TH: 'ปลูกผม', zh_TW: '植髮' },
  },
  {
    ...
    iconSmall: () => null,
    labels: { ko_KR: '피부과', en_US: 'Dermatology', th_TH: 'โรคผิวหนัง', zh_TW: '皮膚科' },
  },
  {
    ...
    icon: () => <DentalIconV2 />,
    iconSmall: () => null,
    labels: { ko_KR: '치과', en_US: 'Dental', th_TH: 'ทันตกรรม', zh_TW: '牙科' },
  },
  {
    ...
    icon: () => <OtherIconV2 />,
    iconSmall: () => null,
    labels: { ko_KR: '기타', en_US: 'Others', th_TH: 'แนะนำ', zh_TW: '其他' },
  },
];
