...
export function QuickMenuError({ lang, dict, error, onRetry }: QuickMenuErrorProps) {
  return (
    <div className='w-full'>
      ...
      <div className='flex flex-col items-center justify-center py-8 text-center'>
        ...
        <h3 className='mb-2 text-sm font-medium text-gray-900'>{dict.quickMenu.error.message}</h3>
        {error && (
        ...
        {onRetry && (
          ...
          >
            {dict.quickMenu.error.retryButton}
          </button>
        )}
      </div>
    </div>
